class TestReportsController < ApplicationController
  ...
  def run
    ...
    worklog_autor = {'bojdv' => 'Бойко Дина', 'shpae' => 'Шпинько Александр', 'pasap'=>'Пащенко Анастасия', 'e.vasilyeva'=>'Васильева Елена', 'uboav' => 'Уборский Алексей', 'povao' => 'Пономарева Анжелика', 'egokk' => 'Егорова Ксения', 'rommv' => 'Романов Максим'}
