...
User.create!(email: "a.pekhov@bssys.com",
             password: "waaaaa",
             password_confirmation: "waaaaa")
User.create!(email: "tester@bssys.com",
             password: "waaaaa",
             password_confirmation: "waaaaa")

Product.create!(product_name: "Личные XML")
Product.create!(product_name: "ТИР. Платформа")
Product.create!(product_name: "e-Government Gate")
Product.create!(product_name: "Сервер Нотификации")
...
Category.create!(product_id: 10000,
                 category_name: 'Тестовые XML',
                 user_id: 10000)
Category.create!(product_id: 10001,
                 category_name: 'Адаптер Active MQ',
                 user_id: 10000)
Category.create!(product_id: 10002,
                 category_name: 'СА ГИС ГМП',
                 user_id: 10000)
Category.create!(product_id: 10003,
                 category_name: 'Firebase Cloud Messaging',
                 user_id: 10000)
Category.create!(product_id: 10004,
                 category_name: 'BOX 230. Инверсия XXI',
                 user_id: 10000)
Category.create!(product_id: 10004,
                 category_name: 'Российский капитал',
                 user_id: 10000)
Category.create!(product_id: 10005,
                 category_name: 'Новикомбанк',
                 user_id: 10000)
Category.create!(product_id: 10006,
                 category_name: 'Group-IB',
                 user_id: 10000)
